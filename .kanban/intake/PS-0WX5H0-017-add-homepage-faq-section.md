---
title: Add homepage FAQ section
id: PS-0WX5H0-017
status: intake
...
Visitors want quick answers to the most common questions (bookings, gluten-free options, whole cakes, parking) without having to call or email.

## Desired Outcome

A short FAQ section appears on the homepage, between the "Visit us" section and the footer, answering the four most common customer questions clearly and concisely.
